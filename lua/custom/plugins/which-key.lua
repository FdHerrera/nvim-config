    ...
    vim.api.nvim_create_autocmd('LspAttach', {
      ...
      callback = function(args)
        ...
        if client.name == 'jdtls' then
          wk.add {
            { '<leader>i', function() require('jdtls').organize_imports() end, desc = 'Organize imports', mode = { 'n', 'v' } },
            { '<leader>x', group = 'Extract', mode = { 'n', 'v' } },
            { '<leader>xv', function() require('jdtls').extract_variable() end, desc = 'Extract variable', mode = { 'n', 'v' } },
            { '<leader>xc', function() require('jdtls').extract_constant() end, desc = 'Extract constant', mode = { 'n', 'v' } },
            { '<leader>xm', function() require('jdtls').extract_method() end, desc = 'Extract method', mode = 'v' },
          }
        end
        wk.add {
          { 'g', group = 'Extract' },
        ...
        wk.add {
          ...
          { '<leader>Dh', require('dapui').eval, desc = 'Evaluate expression', mode = { 'n', 'v' } },
          { '<leader>Dp', require('dap.ui.widgets').preview, desc = 'Preview expression', mode = { 'n', 'v' } },
          {
            '<leader>Ds',
            function()
